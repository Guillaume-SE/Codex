<template>
  <div class="drawer drawer-end h-full">
    ...
    <div class="drawer-side z-[100]">
      ...
      <div class="bg-base-200 text-base-content flex h-full max-h-screen w-80 flex-col">
        ...
        <div class="flex-auto overflow-y-auto p-4 pt-0 [scrollbar-gutter:stable]">
          <slot name="sidebar" />
        </div>

        <div class="border-base-300 flex-none border-t p-4">
